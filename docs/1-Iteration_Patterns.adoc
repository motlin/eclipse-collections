...
:Eclipse-Collections-Kata:      https://github.com/eclipse-collections/eclipse-collections-kata[Eclipse Collections Kata]
:Eclipse-Collections-Mind-Map:  https://github.com/eclipse-collections/eclipse-collections/blob/master/docs/EclipseCollectionsMindMap.png[Eclipse Collections Mind Map]
