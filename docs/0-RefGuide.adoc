...
//
:EC_Kata: https://github.com/eclipse-collections/eclipse-collections-kata[Eclipse Collections Kata]
//

++++
<img align="right" src="https://raw.githubusercontent.com/eclipse-collections/eclipse-collections/master/artwork/eclipse-collections-logo.svg" height="40%" width="40%"></a>
++++
