...
=======
    ...
    default void OrderedIterable_zipWithIndex_target()
    {
        ...
        assertEquals(
                ...
                result);
        assertSame(target, result);
>>>>>>> 645ad93ba (Add allowsOrEnforcesOrder() method to IterableTestCase for unordered collections. Refactor test methods to use allowsOrEnforcesOrder() guard pattern.)
    }
