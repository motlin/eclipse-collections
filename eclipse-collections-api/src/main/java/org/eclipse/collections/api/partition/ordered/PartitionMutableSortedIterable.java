...
/**
 * A PartitionMutableSortedIterable is the result of splitting a MutableSortedIterable into two MutableSortedIterables based on a Predicate.
 ...
 * @since 13.0
 */
public interface PartitionMutableSortedIterable<T> extends PartitionSortedIterable<T>
{
    @Override
    MutableSortedIterable<T> getSelected();

    @Override
    MutableSortedIterable<T> getRejected();
}
