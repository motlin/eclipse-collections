...
import org.eclipse.collections.api.bag.UnmodifiableBag;
import org.eclipse.collections.api.block.procedure.Procedure;

/**
 * UnmodifiableSortedBag is an interface that extends both UnmodifiableBag and MutableSortedBag,
 * providing an unmodifiable view of a sorted bag. All mutating operations throw UnsupportedOperationException.
 * 
 * @since 12.0
 */
public interface UnmodifiableSortedBag<T> extends UnmodifiableBag<T>, MutableSortedBag<T>
{
